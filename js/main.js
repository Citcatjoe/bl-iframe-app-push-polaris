(function ($) {
  ...
  if (/iPad|iPhone|iPod/.test(userAgent) && !window.MSStream) {
    $("#link").attr(
      "href",
      "https://apps.apple.com/ch/app/blick-fr/id1596317983?l=fr-FR"
    );
    $(".img-qr").hide();
  ...
  var phoneSlideUp = new TimelineMax({ paused: false, repeat: 0 }).to(
    $phoneContainerInner,
    0.5,
    { autoAlpha: 1, y: "-=20px", ease: Power4.easeInOut },
    "+=1.0"
  );
